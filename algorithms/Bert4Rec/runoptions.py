...
from algorithms.Bert4Rec.datasets import DATASETS
from algorithms.Bert4Rec.dataloaders import DATALOADERS
from algorithms.Bert4Rec.models import MODELS
from algorithms.Bert4Rec.trainers import TRAINERS
...
# BERT #
parser.add_argument('--bert_max_len', type=int, default=256, help='Length of sequence for bert')
