...
def SasRec(dataset, train_dir, maxlen, dropout_rate, device):
    ...
    if not os.path.isdir(path + args['dataset'] + '_' + args['train_dir']):
        ...
        print()
        os.makedirs(path + args['dataset'] + '_' + args['train_dir'])
    with open(os.path.join(path + args['dataset'] + '_' + args['train_dir'], 'args.txt'), 'w') as f:
    ...
    f = open(os.path.join(path + args['dataset'] + '_' + args['train_dir'], 'log.txt'), 'w')
