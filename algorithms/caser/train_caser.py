...
class Recommender(object):
    ...
    def fit(self, train, test, verbose=False):
        precisionOne = precisionFive = precisionTen = recallOne = recallFive = recallTen = hitOne = hitFive = hitTen = NDCGone = NDGCFive = NDCGTen = []
...
if __name__ == '__main__':
    ...
    # data arguments
    parser.add_argument('--train_root', type=str, default='data/beauty/train.txt')
    parser.add_argument('--test_root', type=str, default='data/beauty/test.txt')
